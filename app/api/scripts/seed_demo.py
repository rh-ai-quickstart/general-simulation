...
Seed scripts are not baked into the API image; use port-forward from your laptop
(see ai-supply-chain-agent `make seed-gen-sim`) or run locally against compose.
"""
